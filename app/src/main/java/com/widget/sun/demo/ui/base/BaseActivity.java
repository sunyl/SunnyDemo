 ...
 */
public class BaseActivity extends FragmentActivity implements BGASwipeBackHelper.Delegate {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBundle = savedInstanceState == null ? getIntent().getExtras() : savedInstanceState.getBundle(PARAM_BASE_STATE);
        long t2 = System.currentTimeMillis() - t1;
        Logger.i("%s onCreateView use time = %d", getClass().getSimpleName(), t2);
    }
    ...
    public void onSaveInstanceState(Bundle outState) {
        ...
        outState.putBundle(PARAM_BASE_STATE, mBundle);
    }
    ...
    private void initSwipeBackFinish() {
        mSwipeBackHelper = new BGASwipeBackHelper(BaseActivity.this, this);
